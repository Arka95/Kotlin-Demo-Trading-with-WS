# Trading Platform with websockets in kotlin

Demo system that enables users to view price histories. 
...
`QuoteEvents` are instantly sent to a queue, when they are reported by the  `QuoteStream`. 
